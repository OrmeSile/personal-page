  ...
  return (
    <Article className={`intro`}>
      <Section id={'intro'} title={'Qui suis-je ?'}>
        ...
        <p>À 30 ans, je peux être embauché en contrat professionnel. Le rythme annoncé est de deux mois en entreprise et deux semaines en école, durant un an et demi.</p>
