...
export const IntroBlock = () => {
  return (
    <Article className={`intro`}>
      ...
      <p>En reconversion depuis 2 ans et après avoir obtenu un titre Développeur Web/Web mobile à l&apos;école ENI, je recherche une entreprise Nantaise pour poursuivre mon parcours auprès de l'école Arinfo.</p>
